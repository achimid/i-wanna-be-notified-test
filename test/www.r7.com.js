...
it('R7', (done) => {
    ...
    const body = { 
        ...
        "scriptTarget": "[...new Set([...document.querySelectorAll('.r7-flex-title-h1__link, .r7-flex-title-h3__link, .r7-flex-title-h4__link, .r7-flex-title-h5__link, .r7-flex-title-h6__link, .r7-flex-title-h7__link')].map(i => i.innerText).filter(i => i))]"
    }
